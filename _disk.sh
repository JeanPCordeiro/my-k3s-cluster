...
#
scp 15_disk.sh root@${MASTER1}:.
scp losetup.service root@${MASTER1}:.
ssh root@${MASTER1} "chmod +x ./15_disk.sh ; ./15_disk.sh"

scp 15_disk.sh root@${MASTER2}:.
scp losetup.service root@${MASTER2}:.
ssh root@${MASTER2} "chmod +x ./15_disk.sh ; ./15_disk.sh"

scp 15_disk.sh root@${MASTER3}:.
scp losetup.service root@${MASTER3}:.
ssh root@${MASTER3} "chmod +x ./15_disk.sh ; ./15_disk.sh"